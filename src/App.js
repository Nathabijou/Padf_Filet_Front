...
function App() {
  ...
  <Route path="/typeprojet/:typeprojetId/petitprojet/:petitprojetId/Addbeneficiaire" element={<AddBeneficiaire />} />
  ...
  <Route path='/beneficiaire/:beneficiaireId/presence/:presenceId/Editpresence' element={<EditPresence/>}/>
